...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	usageAlertRepository := repository.NewUsageAlertRepository(client, db)
	usageAlertService := service.NewUsageAlertService(usageAlertRepository, accountRepository)
	rateLimitService := service.ProvideRateLimitService(accountRepository, usageLogRepository, configConfig, geminiQuotaService, tempUnschedCache, timeoutCounterCache, openAI403CounterCache, settingService, compositeTokenCacheInvalidator, usageAlertService)
	...
	accountUsageService := service.ProvideAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, grokQuotaFetcher, grokQuotaService, openAIQuotaService, usageCache, identityCache, tlsFingerprintProfileService, usageAlertService, openAIGatewayService)
	...
	usageAlertHandler := admin.NewUsageAlertHandler(usageAlertService)
