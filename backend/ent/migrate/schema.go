...
var (
	...
	RealAccountUsageSnapshotsColumns = []*schema.Column{
		...
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "quota_dimension", Type: field.TypeString, Size: 32, Default: "overall"},
		{Name: "platform", Type: field.TypeString, Size: 50},
	...
	RealAccountUsageSnapshotsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{RealAccountUsageSnapshotsColumns[8]},
				RefColumns: []*schema.Column{RealAccountsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
		Indexes: []*schema.Index{
			{
				Name:    "realaccountusagesnapshot_real_account_id_quota_dimension",
				Unique:  true,
				Columns: []*schema.Column{RealAccountUsageSnapshotsColumns[8], RealAccountUsageSnapshotsColumns[3]},
			},
			{
				Name:    "realaccountusagesnapshot_platform",
				Unique:  false,
				Columns: []*schema.Column{RealAccountUsageSnapshotsColumns[4]},
			},
			{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{UsageAlertRulesColumns[15]},
				RefColumns: []*schema.Column{RealAccountsColumns[0]},
				OnDelete:   schema.SetNull,
			},
		},
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageAlertRulesColumns[14], UsageAlertRulesColumns[5]},
			},
			{
				Name:    "usagealertrule_enabled_real_account_id",
				Unique:  false,
				Columns: []*schema.Column{UsageAlertRulesColumns[14], UsageAlertRulesColumns[15]},
			},
			{
				Name:    "usagealertrule_enabled_real_account_id_quota_dimension",
				Unique:  false,
				Columns: []*schema.Column{UsageAlertRulesColumns[14], UsageAlertRulesColumns[15], UsageAlertRulesColumns[6]},
			},
			{
				Name:    "usagealertrule_window",
				Unique:  false,
				Columns: []*schema.Column{UsageAlertRulesColumns[7]},
			},
		},
	}
