...
func init() {
	...
	realaccountusagesnapshotDescSource := realaccountusagesnapshotFields[3].Descriptor()
	...
	realaccountusagesnapshotDescSnapshotJSON := realaccountusagesnapshotFields[4].Descriptor()
	...
	usagealertruleDescMetric := usagealertruleFields[5].Descriptor()
	...
	usagealertruleDescOperator := usagealertruleFields[6].Descriptor()
	...
	usagealertruleDescCooldownMinutes := usagealertruleFields[10].Descriptor()
	...
	usagealertruleDescEnabled := usagealertruleFields[11].Descriptor()
	...
	usagealertstateDescLastStatus := usagealertstateFields[4].Descriptor()
