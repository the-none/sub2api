...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Proxy, c.RealAccount, c.RealAccountUsageSnapshot, c.RedeemCode,
		c.SecuritySecret, c.Setting, c.SubscriptionPlan, c.TLSFingerprintProfile,
		c.UsageAlertBinding, c.UsageAlertRule, c.UsageAlertState, c.UsageAlertWebhook,
...
type (
	hooks struct {
		...
		RealAccount, RealAccountUsageSnapshot, RedeemCode, SecuritySecret, Setting,
		SubscriptionPlan, TLSFingerprintProfile, UsageAlertBinding, UsageAlertRule,
		UsageAlertState, UsageAlertWebhook, UsageCleanupTask, UsageLog, User,
