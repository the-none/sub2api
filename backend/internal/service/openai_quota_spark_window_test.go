...
func TestResetCreditTargetedSendsStableCreditAndRedeemIDs(t *testing.T) {
	...
	reconciler := &openAIQuotaResetReconcilerRecorder{}
	...
	require.Empty(t, reconciler.accountIDs, "targeted auto-reset must use its caller's post-process instead of the manual reconciler")
}
