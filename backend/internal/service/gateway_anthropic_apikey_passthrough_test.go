...
func TestGatewayService_ParseSSEUsagePassthrough_DeltaZeroBreakdownWithoutAggregatePreservesStart(t *testing.T) {
	usage := &ClaudeUsage{}
	start := `{"type":"message_start","message":{"usage":{"cache_creation_input_tokens":1000,"cache_creation":{"ephemeral_5m_input_tokens":0,"ephemeral_1h_input_tokens":1000}}}}`
	parseSSEUsagePassthrough(start, usage)

	delta := `{"type":"message_delta","usage":{"cache_creation_input_tokens":0,"cache_creation":{"ephemeral_5m_input_tokens":0,"ephemeral_1h_input_tokens":0}}}`
