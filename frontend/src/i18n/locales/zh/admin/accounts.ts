export default {
  ...
  "defaultEnabled": "默认让符合条件的账号参与（账号可单独关闭）",
  "proxy": "默认采集代理 URL",
  "clearProxy": "清除后台代理覆盖，恢复配置文件中的代理",
  "concurrency": "最大同时采集数（每个服务实例）",
  "advanced": "高级设置",
  "targetLength": "目标票据长度",
  "models": "采集模型（每行一个）",
  "modelsHint": "填写实际出站模型名；账号覆盖后仅采集所列模型。",
  "retry_seconds": "失败重试基础间隔（秒）",
  "timeout_seconds": "单次请求超时（秒）",
  "ttl_seconds": "本地有效期（秒）",
  "refresh_before_seconds": "提前续期（秒）",
  "max_backoff_seconds": "最大失败退避（秒）",
  "timingHint": "有效票仅在临近过期时续期；失败后逐步延长重试间隔。有效期由本地推算，调大不会延长上游真实有效期。提前续期必须小于有效期。",
  "failClosed": "没有有效票据时",
  "block": "跳过该账号的此模型",
  "allow": "允许原请求继续",
  "instructions": "系统指令",
  ...
  "preview": "查看采集请求预览",
  "saveGlobal": "保存 Ticket 全局配置",
  "saveAccount": "保存此账号的 Ticket 配置",
  "saved": "已保存，配置将在下一次调度检查生效。",
  "loadFailed": "无法加载 Ticket 配置，请重试。",
  "saveFailed": "保存失败",
  "participation": "此账号是否参与",
  "inherit": "继承全局默认",
  "on": "开启",
  "off": "关闭",
  "override": "为此账号自定义模型、时间参数与提示词",
  "inheritedOptions": "查看继承的参数",
  "proxyId": "指定采集代理",
  ...
  "lastSuccess": "最近成功：",
  "nextAttempt": "下次计划：",
  "attempts": "本实例尝试 {count} 次，连续失败 {failures} 次",
  "expires": "现有票据有效至 {time}",
  "harvest": "立即采集一次",
  "refresh": "刷新",
  ...
  "states": {
    ...
    "backoff": "失败冷却中",
    "disabled": "已关闭",
    "unsupported": "不支持此账号类型",
    "inactive": "账号未启用",
    "configuration_missing": "采集代理配置缺失或不可用"
  },
  "reasons": {
    "proxy_unavailable": "采集代理不可用",
    "proxy_missing": "未配置采集代理",
    "transport_unavailable": "请求服务不可用",
    "token": "无法取得账号凭证",
    "cancelled": "任务已取消",
    "transport_error": "连接失败或请求超时",
    "http_error": "上游返回错误",
    "header_missing": "响应未携带票据",
    "length_mismatch": "票据长度不符",
    "prefix_mismatch": "票据格式不符",
    "disabled": "采集已关闭",
    "persist_failed": "票据可用，但数据库保存失败"
  },
  "triggers": {
    "started": "已开始采集。",
    "running": "该模型正在采集，请稍候。",
    "cooldown": "该模型处于失败冷却期，请等待下次计划时间。",
    "busy": "采集并发已满，请稍后再试。",
    "ready": "已有有效票据。"
  }
},
