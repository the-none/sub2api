export default {
  ...
  "defaultEnabled": "Enable eligible accounts by default (individual accounts can opt out)",
  "proxy": "Default harvest proxy URL",
  "clearProxy": "Clear the admin override and restore the proxy from the configuration file",
  "concurrency": "Maximum concurrent probes per instance",
  "advanced": "Advanced settings",
  "targetLength": "Target ticket length",
  "models": "Harvest models (one per line)",
  "modelsHint": "Use outbound model names. An account override only harvests its listed models.",
  "retry_seconds": "Base retry interval (seconds)",
  "timeout_seconds": "Request timeout (seconds)",
  "ttl_seconds": "Local lifetime (seconds)",
  "refresh_before_seconds": "Refresh before expiry (seconds)",
  "max_backoff_seconds": "Maximum failure backoff (seconds)",
  "timingHint": "Valid tickets are refreshed near expiry. Failures increase the retry delay. The lifetime is estimated locally; raising it cannot extend upstream validity. Refresh lead time must be less than the lifetime.",
  "failClosed": "When no valid ticket exists",
  "block": "Skip this account for this model",
  "allow": "Allow the original request",
  "instructions": "System instructions",
  "userPrompt": "User prompt",
  "resetPrompts": "Restore default prompts",
  "preview": "Preview harvest request",
  "saveGlobal": "Save global ticket settings",
  "saveAccount": "Save account ticket settings",
  "saved": "Saved. Changes apply on the next scheduling check.",
  "loadFailed": "Unable to load ticket settings. Please retry.",
  "saveFailed": "Save failed",
  "participation": "Account participation",
  "inherit": "Inherit global default",
  "on": "Enabled",
  "off": "Disabled",
  "override": "Customize models, timing and prompts for this account",
  "inheritedOptions": "View inherited options",
  ...
  "nextAttempt": "Next scheduled attempt: ",
  "attempts": "{count} attempts on this instance, {failures} consecutive failures",
  "expires": "Existing ticket valid until {time}",
  "harvest": "Harvest once now",
  "refresh": "Refresh",
  ...
  "states": {
    ...
    "backoff": "Failure cooldown",
    "disabled": "Disabled",
    "unsupported": "Unsupported account type",
    "inactive": "Account inactive",
    "configuration_missing": "Harvest proxy missing or unavailable"
  },
  "reasons": {
    "proxy_unavailable": "Harvest proxy unavailable",
    "proxy_missing": "Harvest proxy not configured",
    "transport_unavailable": "Transport unavailable",
    "token": "Unable to obtain account credentials",
    "cancelled": "Task cancelled",
    "transport_error": "Connection failure or timeout",
    "http_error": "Upstream HTTP error",
    "header_missing": "Ticket header missing",
    "length_mismatch": "Ticket length mismatch",
    "prefix_mismatch": "Ticket format mismatch",
    "disabled": "Harvesting disabled",
    "persist_failed": "Ticket available but database persistence failed"
  },
  "triggers": {
    "started": "Harvesting started.",
    "running": "Already harvesting this model.",
    "cooldown": "This model is cooling down. Wait until the next scheduled attempt.",
    "busy": "Harvest concurrency limit reached. Try again later.",
    "ready": "A valid ticket is available."
  }
},
